...
```{r}
mod1lab9 <- stan(data = stan_data, file = here("code/models/lab9_1.stan"))
```
...
```{r}
mod2lab9 <- stan(data = stan_data, file = here("code/models/lab9_2.stan"))
```
...
```{r}
mod3lab9 <- stan(data = stan_data, file = here("code/models/lab9_3.stan"))
```
...
res %>% 
  ...
  geom_errorbar(aes(ymin = lower_mod1, ymax = upper_mod1, color = "Model 1")) +
